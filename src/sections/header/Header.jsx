                ...
                <div className="row">
                    ...
                    <div className="col-xl-8">
                        ...
                        <div className="header-text">
                            High-value, high-impact customized corporate
                            training programmed for teams, delivered globally and
                ...
                <div className="row">
                    ...
                    <div className="col-xl-4 ">
                        <div className="add-contact" onClick={toggle}>
                            <button>
                                <img src="/assets/images/add-contact.svg" alt="add contact image"/>
